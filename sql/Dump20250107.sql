...
CREATE TABLE `travelnote` (
  ...
  CONSTRAINT `schedule_travelnote` FOREIGN KEY (`s_id`) REFERENCES `travelnote_schedule` (`s_id`)
...
--
-- Table structure for table `travelnote_company`
--

DROP TABLE IF EXISTS `travelnote_company`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `travelnote_company` (
...
--
-- Dumping data for table `travelnote_company`
--

LOCK TABLES `travelnote_company` WRITE;
/*!40000 ALTER TABLE `travelnote_company` DISABLE KEYS */;
INSERT INTO `travelnote_company` VALUES (1,'hanho','아이디','번호 4자리','우리의 여행을 기록하는','TRAVEL NOTE','테스트 노트 입니다.',100,'하루 한 줄, 오늘 하루를 기록해 봅시다~!');
/*!40000 ALTER TABLE `travelnote_company` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `travelnote_file`
--

DROP TABLE IF EXISTS `travelnote_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `travelnote_file` (
...
CREATE TABLE `travelnote_menu` (
  ...
  CONSTRAINT `company_menu` FOREIGN KEY (`company_id`) REFERENCES `travelnote_company` (`company_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `travelnote_menu`
--

LOCK TABLES `travelnote_menu` WRITE;
/*!40000 ALTER TABLE `travelnote_menu` DISABLE KEYS */;
INSERT INTO `travelnote_menu` VALUES (1,'공지사항','notice',1),(2,'과정소개','program',1),(3,'시간표','schedule',1),(4,'트래블노트 작성','travelnote',1),(5,'Reflection','reflection',1);
/*!40000 ALTER TABLE `travelnote_menu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `travelnote_notice`
--

DROP TABLE IF EXISTS `travelnote_notice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `travelnote_notice` (
...
--
-- Dumping data for table `travelnote_question`
--

LOCK TABLES `travelnote_question` WRITE;
/*!40000 ALTER TABLE `travelnote_question` DISABLE KEYS */;
INSERT INTO `travelnote_question` VALUES (1,'안녕하세요~','TEXT','안녕하세요!!!sasdads',3),(2,'당신의 이미지를 보여주세요!','IMG',NULL,3),(3,'나의 유형과 특징을 작성해주세요.','TEXT',NULL,4),(4,'질문 2 ~ 두개가 나와야해!!','TEXT',NULL,4),(5,'제작한 비전 기록물의 사진을 업로드 해주세요.','IMG',NULL,5),(6,'활동 소감을 적어주세요.','TEXT',NULL,5),(7,'asfdsasdfsdaffdsasfadsfda','TEXT',NULL,6),(8,'ㅁㄴㅇㄹㅇㅁㄴㄹㅇㄴㅁㄹㄹㅇㅁㄹㄴㅁㅇ','TEXT',NULL,6);
/*!40000 ALTER TABLE `travelnote_question` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `travelnote_schedule`
--

DROP TABLE IF EXISTS `travelnote_schedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `travelnote_schedule` (
...
-- Dump completed on 2025-01-07 20:06:56
